...
function createfinalreports() {
	...
	// RTCP Stats
		...
		mediaReports.push({
			...
			pause: 200,
			payload: '{"CORRELATION_ID":"'+a_leg_call_id + '","RTP_SIP_CALL_ID":"'+a_leg_call_id+'","SR_DELAY":0,"INTERARRIVAL_JITTER":0,"REPORT_TS":'+uac_to_sbc_final.REPORT_TS+',"TOTAL_PK":'+uac_to_sbc_final.TOTAL_PK+',"TOTAL_RTCP_PK":14,"CUM_PACKET_LOSS":'+uac_to_sbc_final.PACKET_LOSS+',"PERCENTAGE_LOSS":0,"MAX_INTERARRIVAL_JITTER":'+(uac_to_sbc_final.MAX_JITTER+150)+',"MAX_SR_DELAY":0,"MAX_PERCENTAGE_LOSS":0.391,"MEAN_PERCENTAGE_LOSS":0.055,"MEAN_INTERARRIVAL_JITTER":'+(uac_to_sbc_final.MEAN_JITTER+150)+',"MIN_MOS":'+(uac_to_sbc_final.MIN_MOS-1)+',"MEAN_MOS":'+(uac_to_sbc_final.MEAN_MOS-1).toFixed(3)+',"MOS":'+(uac_to_sbc_final.MOS-1).toFixed(3)+',"RFACTOR":'+uac_to_sbc_final.RFACTOR+',"MIN_RFACTOR":'+uac_to_sbc_final.MIN_RFACTOR+',"MEAN_RFACTOR":'+uac_to_sbc_final.MEAN_RFACTOR+',"SRC_IP":"'+priv_ip+'","SRC_PORT":'+rtpPorts.uac_sbc.uac_rtp+',"DST_IP":"'+priv_nat+'","DST_PORT":'+rtpPorts.uac_sbc.sbc_rtp+',"OCTET_COUNT":208160,"SSRC_CHG":'+uac_to_sbc_final.SSRC_CHG+',"PKT_TYPE_REPORT":[200,0,0],"HIGH_EXT_SEQ":12656,"SSRC":"0xedc34144","DIR":0,"REPORT_NAME":"'+priv_ip+':'+rtpPorts.uac_sbc.uac_rtp+'","PARTY":0,"IP_QOS":0,"INFO_VLAN":0,"VIDEO":0,"REPORT_START":'+Math.floor((baseTime/1000)-10000)+',"REPORT_END":'+Math.floor((baseTime/1000)+100)+',"TYPE":"HANGUP","STYPE":"HEPAGENT-RTCP-1.1.107","SOURCE":"RTCP"}'
		});
		...
		mediaReports.push({
			...
			pause: 200,
			payload: '{"CORRELATION_ID":"'+a_leg_call_id + '","RTP_SIP_CALL_ID":"'+a_leg_call_id+'","SR_DELAY":0,"INTERARRIVAL_JITTER":0,"REPORT_TS":'+sbc_to_uac_final.REPORT_TS+',"TOTAL_PK":'+sbc_to_uac_final.TOTAL_PK+',"TOTAL_RTCP_PK":14,"CUM_PACKET_LOSS":'+sbc_to_uac_final.PACKET_LOSS+',"PERCENTAGE_LOSS":0,"MAX_INTERARRIVAL_JITTER":'+(sbc_to_uac_final.MAX_JITTER+150)+',"MAX_SR_DELAY":0,"MAX_PERCENTAGE_LOSS":0.391,"MEAN_PERCENTAGE_LOSS":0.055,"MEAN_INTERARRIVAL_JITTER":'+(sbc_to_uac_final.MEAN_JITTER+150)+',"MIN_MOS":'+(sbc_to_uac_final.MIN_MOS-1).toFixed(3)+',"MEAN_MOS":'+(sbc_to_uac_final.MEAN_MOS-1).toFixed(3)+',"MOS":'+(sbc_to_uac_final.MOS-1).toFixed(3)+',"RFACTOR":'+sbc_to_uac_final.RFACTOR+',"MIN_RFACTOR":'+sbc_to_uac_final.MIN_RFACTOR+',"MEAN_RFACTOR":'+sbc_to_uac_final.MEAN_RFACTOR+',"SRC_IP":"'+priv_nat+'","SRC_PORT":'+rtpPorts.uac_sbc.sbc_rtp+',"DST_IP":"'+priv_ip+'","DST_PORT":'+rtpPorts.uac_sbc.uac_rtp+',"OCTET_COUNT":208160,"SSRC_CHG":'+sbc_to_uac_final.SSRC_CHG+',"PKT_TYPE_REPORT":[200,0,0],"HIGH_EXT_SEQ":12656,"SSRC":"0xedc34144","DIR":0,"REPORT_NAME":"'+priv_nat+':'+rtpPorts.uac_sbc.sbc_rtp+'","PARTY":0,"IP_QOS":0,"INFO_VLAN":0,"VIDEO":0,"REPORT_START":'+Math.floor((baseTime/1000)-10000)+',"REPORT_END":'+Math.floor(baseTime/1000)+100+',"TYPE":"HANGUP","STYPE":"HEPAGENT-RTCP-1.1.107","SOURCE":"RTCP"}'
		});
