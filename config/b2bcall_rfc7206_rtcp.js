...
var hash = function(str) {
  if(!str) return "00000000000000000000000000000000";
  str = str + '';
...
{    
	...
	'Accept: application/sdp, application/dtmf-relay\r\n'+
        'Session-ID: ' + getSessionId(caller+domain)+';remote='+ getSessionId()+'\r\n' +
	'Content-Length:   313\r\n'+
	'\r\n'+
	'v=0\r\n'+
	...
	'P-Auth-IP: '+priv_nat+'\r\n'+
	'Server: SIP Proxy\r\n'+
        'Session-ID: ' + getSessionId(callee+domain)+';remote='+ getSessionId(caller+domain)+'\r\n' +
	'Content-Length: 0\r\n'+
	'\r\n\r\n'
